...
var $author$project$Main$Model = F6(
	function (timer, completed, alarmRunning, top, left, drag) {
		return {alarmRunning: alarmRunning, completed: completed, drag: drag, left: left, timer: timer, top: top};
	});
...
var $author$project$Main$initialTimer = $author$project$Main$Initial($author$project$Main$init_minutes * $author$project$Main$seconds_per_minute);
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		A6($author$project$Main$Model, $author$project$Main$initialTimer, 0, false, 20, 20, $elm$core$Maybe$Nothing),
		$elm$core$Platform$Cmd$none);
};
...
var $author$project$Main$receiveTick = _Platform_incomingPort('receiveTick', $elm$json$Json$Decode$string);
var $author$project$Main$subscriptions = function (model) {
	var _v0 = model.timer;
	if (_v0.$ === 'Running') {
		return $author$project$Main$receiveTick($author$project$Main$Tick);
	} else {
...
var $author$project$Main$continueTimer = function (model) {
	var _v0 = model.timer;
	if (_v0.$ === 'Paused') {
		var s = _v0.a;
		return _Utils_update(
...
var $author$project$Main$drag = F4(
	function (model, dragStart, x, y) {
		var dy = dragStart.y - y;
		var top = model.top - dy;
		var dx = dragStart.x - x;
		var left = model.left - dx;
		var pos = $elm$core$Maybe$Just(
			A2($author$project$Main$Pos, left, top));
		return _Utils_update(
			model,
			{drag: pos, left: left, top: top});
	});
...
var $author$project$Main$startDrag = F3(
	function (model, x, y) {
		var pos = A2($author$project$Main$Pos, x, y);
		return _Utils_update(
			model,
			{
				drag: $elm$core$Maybe$Just(pos)
			});
	});
...
var $author$project$Main$stopDrag = function (model) {
	return _Utils_update(
		model,
...
var $author$project$Main$stopTimer = function (model) {
	...
	if (_v0.$ === 'Running') {
		...
		return _Utils_update(
			model,
			{
				timer: $author$project$Main$Paused(s)
			});
	} else {
		return model;
	}
...
var $author$project$Main$tick = function (model) {
	...
	if (_v0.$ === 'Running') {
		var s = _v0.a;
		var remaining_seconds = A2($elm$core$Basics$max, 0, s - 1);
		return (!remaining_seconds) ? _Utils_Tuple2(
			...
			_Utils_update(
				model,
				{
					timer: $author$project$Main$Running(remaining_seconds)
				}),
			$elm$core$Platform$Cmd$none);
	} else {
		return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'Continue':
				return _Utils_Tuple2(
					$author$project$Main$continueTimer(model),
					$elm$core$Platform$Cmd$none);
			case 'Stop':
				return _Utils_Tuple2(
					$author$project$Main$stopTimer(model),
					$elm$core$Platform$Cmd$none);
			case 'Tick':
				return $author$project$Main$tick(model);
			case 'ResetTimer':
				return $author$project$Main$resetTimer(model);
			case 'MouseMove':
				var x = msg.a;
				var y = msg.b;
				var _v1 = model.drag;
				if (_v1.$ === 'Nothing') {
					...
					var pos = _v1.a;
					return _Utils_Tuple2(
						A4($author$project$Main$drag, model, pos, x, y),
						$elm$core$Platform$Cmd$none);
				}
			case 'MouseDown':
				var x = msg.a;
				var y = msg.b;
				return _Utils_Tuple2(
					A3($author$project$Main$startDrag, model, x, y),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
					$author$project$Main$stopDrag(model),
					$elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$Main$onMouseMove = function (message) {
	return A2(
		$elm$html$Html$Events$on,
		'mousemove',
...
var $author$project$Main$seconds = function (s) {
	return A2($elm$core$Basics$modBy, 60, s);
};
var $author$project$Main$zeroPad = function (n) {
	return (n < 10) ? ('0' + $elm$core$String$fromInt(n)) : $elm$core$String$fromInt(n);
};
var $author$project$Main$secondsToTimerStr = function (n) {
	var s = $author$project$Main$zeroPad(
		$author$project$Main$seconds(n));
	var m = $author$project$Main$zeroPad(
		$author$project$Main$minutes(n));
	return m + (':' + s);
};
...
var $author$project$Main$viewTimerWidget = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						_Utils_Tuple2('timer', true)
					])),
				A2(
				$elm$html$Html$Attributes$style,
				'top',
				$author$project$Main$px(model.top)),
				A2(
				$elm$html$Html$Attributes$style,
				'left',
				$author$project$Main$px(model.left)),
				A2($elm$html$Html$Attributes$style, 'position', 'absolute'),
				$author$project$Main$onMouseDown($author$project$Main$MouseDown),
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Main$viewTimerWidget(model)
			]));
};
var $author$project$Main$main = $elm$browser$Browser$element(
	{init: $author$project$Main$init, subscriptions: $author$project$Main$subscriptions, update: $author$project$Main$update, view: $author$project$Main$view});
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"Tick":["String.String"],"Start":[],"Continue":[],"Stop":[],"ResetTimer":[],"MouseDown":["Basics.Int","Basics.Int"],"MouseMove":["Basics.Int","Basics.Int"],"MouseUp":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));