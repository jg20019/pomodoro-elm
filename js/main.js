...
var $author$project$Main$Model = function (timer) {
	return {timer: timer};
};
...
var $author$project$Main$StopAlarm = {$: 'StopAlarm'};
...
var $author$project$Main$stopAlarmButon = A2(
	$elm$html$Html$button,
	_List_fromArray(
		[
			$elm$html$Html$Events$onClick($author$project$Main$StopAlarm)
		]),
	_List_fromArray(
		[
			$elm$html$Html$text('Stop Alarm')
		]));
...
var $author$project$Main$viewControls = function (timer) {
	var stop_alarm_button = function () {
		if (timer.$ === 'Finished') {
			return $author$project$Main$stopAlarmButon;
		} else {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Main$viewControls(model.timer)
			]));
};
